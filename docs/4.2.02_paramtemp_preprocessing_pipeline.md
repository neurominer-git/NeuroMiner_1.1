...
:::{note}
If previous preprocessing operations change the dimensionality of the feature space (e.g. pruning, see 4.2.3.11) these changes are propagated to the user-provided logical feature indices used by the imputation module.
:::
